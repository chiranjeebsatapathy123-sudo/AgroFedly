...
urlpatterns = [
    ...
    path("api/agriculture/weather/current/", views.weather_current_api, name="weather_data"),
    path("api/agriculture/weather/forecast/", views.weather_forecast_api, name="weather_forecast_data"),
    ...
    path("organization/admin/users/<int:user_id>/edit/", views.admin_user_edit, name="admin_user_edit"),
    path("organization/admin/organizations/", views.admin_organizations, name="admin_organizations"),
    path("organization/admin/organizations/<int:org_id>/edit/", views.admin_organization_edit, name="admin_organization_edit"),
    ...
    path("logistics/drivers/create/", views.logistics_driver_create, name="logistics_driver_create"),
    path("logistics/drivers/<int:driver_id>/edit/", views.logistics_driver_edit, name="logistics_driver_edit"),
    path("logistics/drivers/<int:driver_id>/delete/", views.logistics_driver_delete, name="logistics_driver_delete"),
    path("logistics/drivers/<int:driver_id>/profile/", views.logistics_driver_profile, name="logistics_driver_profile"),
    ...
    path("api/weather/", views.weather_current_api, name="api_weather"),
